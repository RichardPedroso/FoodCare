...
-- Insert users with encrypted passwords for JWT profile
INSERT INTO user_model (name, email, password, phone, user_type, municipality_id) 
VALUES ('Admin', 'admin@foodcare.com', crypt('admin123', gen_salt('bf')), '11999999999', 'admin', 1);

INSERT INTO user_model (name, email, password, phone, user_type, municipality_id) 
VALUES ('tiburgus', 'tiburgus@gmail.com', crypt('1234567', gen_salt('bf')), '11999999978', 'donor', 1);

INSERT INTO user_model (name, email, password, phone, user_type, municipality_id) 
VALUES ('aroldus', 'aroldus@gmail.com', crypt('1234567', gen_salt('bf')), '11999999967', 'donor', 2);

INSERT INTO user_model (name, email, password, phone, user_type, family_income, people_quantity, municipality_id, documents, able) 
VALUES ('tiburgas', 'tiburgas@gmail.com', crypt('12345678', gen_salt('bf')), '11999999956', 'beneficiary', 2222.0, 4, 3, ARRAY['data:image/jpeg;base64,'], FALSE);

INSERT INTO user_model (name, email, password, phone, user_type, family_income, people_quantity, municipality_id, documents, able) 
VALUES ('tiburgos', 'tiburgos@gmail.com', crypt('123123', gen_salt('bf')), '11999999945', 'beneficiary', 1234.0, 4, 4, ARRAY['data:image/jpeg;base64,'], TRUE);

INSERT INTO user_model (name, email, password, phone, user_type, municipality_id) 
VALUES ('Edu du', 'edu@gmail.com', crypt('123456', gen_salt('bf')), '11345678902', 'donor', 2);

INSERT INTO user_model (name, email, password, phone, user_type, municipality_id) 
VALUES ('babu a', 'babu@gmail.com', crypt('asdzxc', gen_salt('bf')), '11111111111', 'donor', 5);

INSERT INTO user_model (name, email, password, phone, user_type, family_income, people_quantity, municipality_id, documents, able) 
VALUES ('zezao', 'zezao@gmail.com', crypt('123asd', gen_salt('bf')), '12312312312', 'beneficiary', 2000.0, 5, 6, ARRAY['data:image/jpeg;base64,'], FALSE);

INSERT INTO user_model (name, email, password, phone, user_type, family_income, people_quantity, municipality_id, documents, able) 
VALUES ('pedro', 'pedro@123.mail', crypt('pedro', gen_salt('bf')), '66666666666', 'beneficiary', 1000000.0, 10, 7, ARRAY[]::TEXT[], FALSE);

INSERT INTO user_model (name, email, password, phone, user_type, municipality_id) 
VALUES ('Richard', 'richard123@gmail.com', crypt('24242424', gen_salt('bf')), '24924242424', 'donor', 8);
...
VALUES ('jubileu', 'jubileu@gmail.com', crypt('123456', gen_salt('bf')), '(35) 99988-8888', 'beneficiary', 1200.0, 3, 9, FALSE, 0, ARRAY[]::TEXT[]);
...
-- Doações pendentes (donation_status = 'Pendente')
...
INSERT INTO donation_product (quantity, expiration_date, unit, donation_id, product_id) VALUES (1, '2025-12-31T00:00:00.000Z', 2, 2, 2);
INSERT INTO donation_product (quantity, expiration_date, unit, donation_id, product_id) VALUES (1, NULL, 1, 3, 4);
INSERT INTO donation_product (quantity, expiration_date, unit, donation_id, product_id) VALUES (1, NULL, 1, 19, 23);
INSERT INTO donation_product (quantity, expiration_date, unit, donation_id, product_id) VALUES (1, '2025-12-31T00:00:00.000Z', 2, 20, 1);

-- Doações confirmadas (donation_status = 'Em estoque')
...
INSERT INTO donation_product (quantity, expiration_date, unit, donation_id, product_id) VALUES (1, '2025-12-31T00:00:00.000Z', 1, 6, 2);
...
INSERT INTO donation_product (quantity, expiration_date, unit, donation_id, product_id) VALUES (1, '2025-12-31T00:00:00.000Z', 1, 9, 1);
INSERT INTO donation_product (quantity, expiration_date, unit, donation_id, product_id) VALUES (1, '2025-12-31T00:00:00.000Z', 2, 10, 2);
...
INSERT INTO donation_product (quantity, expiration_date, unit, donation_id, product_id) VALUES (1, '2025-12-31T00:00:00.000Z', 2, 15, 2);
